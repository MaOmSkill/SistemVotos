...
class Red_VhForm(forms.ModelForm):
    class Meta:
        ...
        fields =['ensamblaje', 'caracter', 'b_frecuencia' , 'r_frecuencia', 't_equipo' , 'potencia_s','alcance', 'modulacion','accesorio' , 'config', 
         'expediente', 'calculo_a', 'instalacion' , 'conectividad', 'indicativos', 'autenticacion', 'prearreglado' , 'micro', 'tiempo', 'uno']
        
class CriptografiaForm(forms.ModelForm):
    class Meta:
        model = Criptografia
        fields =['principios', 'metodos' , 'medidas', 'cifrado' , 'decifrado','tiempo', 'dos']
        
class Red_HForm(forms.ModelForm):
    class Meta:
        model = Red_HF
        fields =['ensamblaje', 'caracter', 'b_frecuencia' , 'r_frecuencia', 't_equipo' , 'potencia_s','alcance', 'modulacion','accesorio' , 'config', 
         'expediente', 'calculo_a', 'instalacion' , 'expedienteOT', 'indicativos', 'autenticacion', 'prearreglado' , 'micro', 'tiempo', 'tres']
        
class MensajeroForm(forms.ModelForm):
    class Meta:
        model = Mensajero
        fields =['rmsjcf', 'smsjero' , 'imsjero', 'smsje' , 'vtamjs','tpomsj', 'entsalid','celibro' , 'clastrans', 
         'nofiexp', 'fcha', 'pra' , 'dcofic', 'hra', 'fgrado', 'pfsica' , 'trmsje', 'tepleado', 'cuatro']
...
class MtrrForm(forms.ModelForm):
    class Meta:
        ...
        fields =['explmis', 'orgunid' , 'elinea', 'encolum' , 'dprfr', 'segdesp','pcolm', 'laperfue','sectiro' , 'sectvig', 
         'usoarms', 'detinfor', 'centequi' , 'observa', 'contequipo', 'Fugmovi', 'adopdisp' , 'cinco']
        
        
class Codigo_MorseForm(forms.ModelForm):
    class Meta:
        model = Codigo_Morse
        fields =['codinter','qsc', 'usocorr' , 'decifrad', 'timpempl' , 'seis']
